...
def load_system_prompts():
    ...
    try:
        ...
        logger.error(f"[load_system_prompts]在加载系统提示语时发生错误, {str(e)}")
        raise e
...
def load_rag_prompts():
    ...
    try:
        ...
        logger.error(f"[load_rag_prompts]在加载RAG提示语时发生错误, {str(e)}")
        raise e
...
def load_report_prompts():
    ...
    try:
        ...
        logger.error(f"[load_report_prompts]在加载report提示语时发生错误, {str(e)}")
        raise e
